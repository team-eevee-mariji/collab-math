      ...
      <div className='w-full max-w-2xl rounded-3xl border-4 border-slate-800 bg-white shadow-xl p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-[1.3fr_1fr] gap-4 mb-4'>
          ...
          <section className='rounded-2xl bg-white border-2 border-slate-800 p-5'>
            ...
            <form onSubmit={handleSubmit} className='generate-room space-y-3'>
              <NameInput
                value={name}
                onChange={setName}
                placeholder='Type your name here'
                className='name-input w-80 mx-auto mb-2 rounded-lg bg-white px-3 py-2 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-300 text-sm'
              />
              ...
              <ActionButton
                ...
                disabled={!canSubmit}
                label='Find a Match'
                className='w-60 mx-auto rounded-lg py-2 font-semibold text-slate-900 border border-slate-300 hover:bg-slate-50 disabled:opacity-50 text-sm'
              />
